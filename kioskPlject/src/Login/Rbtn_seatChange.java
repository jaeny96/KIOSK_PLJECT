...
public class Rbtn_seatChange extends JButton{
	
	ImageIcon icon;
	public Rbtn_seatChange() { super(); decorate();} 
	public Rbtn_seatChange(String text) { super(text);decorate();} 
	public Rbtn_seatChange(Action action) { super(action); decorate();} 
	public Rbtn_seatChange(Icon icon) { super(icon); decorate();} 
	public Rbtn_seatChange(String text, Icon icon) { super(text, icon); decorate();}
	...
	public void paintComponent(Graphics g) {
		...
		icon = new ImageIcon("./image/seatChange.png");
