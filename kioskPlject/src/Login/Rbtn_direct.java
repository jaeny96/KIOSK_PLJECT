...
public class Rbtn_direct extends JButton{
	
	ImageIcon icon;
	public Rbtn_direct() { super(); decorate();} 
	public Rbtn_direct(String text) { super(text);decorate();} 
	public Rbtn_direct(Action action) { super(action); decorate();} 
	public Rbtn_direct(Icon icon) { super(icon); decorate();} 
	public Rbtn_direct(String text, Icon icon) { super(text, icon); decorate();}
	...
	public void paintComponent(Graphics g) {
		...
		icon = new ImageIcon("./image/direct.png");
