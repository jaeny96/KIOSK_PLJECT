...
public class Rbtn_chk_out extends JButton{
	
	ImageIcon icon;
	public Rbtn_chk_out() { super(); decorate();} 
	public Rbtn_chk_out(String text) { super(text);decorate();} 
	public Rbtn_chk_out(Action action) { super(action); decorate();} 
	public Rbtn_chk_out(Icon icon) { super(icon); decorate();} 
	public Rbtn_chk_out(String text, Icon icon) { super(text, icon); decorate();}
