...
public class Rbtn_chk_in extends JButton{
	
	ImageIcon icon;
	public Rbtn_chk_in() { super(); decorate();} 
	public Rbtn_chk_in(String text) { super(text);decorate();} 
	public Rbtn_chk_in(Action action) { super(action); decorate();} 
	public Rbtn_chk_in(Icon icon) { super(icon); decorate();} 
	public Rbtn_chk_in(String text, Icon icon) { super(text, icon); decorate();}
	...
	public void paintComponent(Graphics g) {
		...
		icon = new ImageIcon("./image/entrance.png");
