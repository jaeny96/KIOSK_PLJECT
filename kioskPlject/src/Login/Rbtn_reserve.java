...
public class Rbtn_reserve extends JButton{
	
	ImageIcon icon;
	public Rbtn_reserve() { super(); decorate();} 
	public Rbtn_reserve(String text) { super(text);decorate();} 
	public Rbtn_reserve(Action action) { super(action); decorate();} 
	public Rbtn_reserve(Icon icon) { super(icon); decorate();} 
	public Rbtn_reserve(String text, Icon icon) { super(text, icon); decorate();}
	...
	public void paintComponent(Graphics g) {
		...
		icon = new ImageIcon("./image/reserve.png");
