...
public class Rbtn_home extends JButton{
	
	ImageIcon icon;
	public Rbtn_home() { super(); decorate();} 
	public Rbtn_home(String text) { super(text);decorate();} 
	public Rbtn_home(Action action) { super(action); decorate();} 
	public Rbtn_home(Icon icon) { super(icon); decorate();} 
	public Rbtn_home(String text, Icon icon) { super(text, icon); decorate();}
	...
	public void paintComponent(Graphics g) {
		...
		icon = new ImageIcon("./src/image/home_btn.png");
